    ...
    <div className={`container mx-auto px-5 md:px-16 lg:px-24 py-[80px] w-full services-content ${language === 'ar' ? 'text-right' : ''}`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
        ...
        <Link href="/service/web-development" className="block">
          <div className="rounded-lg cursor-pointer bg-blue-50 border border-blue-100 transition-all duration-300 hover:shadow-lg hover:translate-y-[-4px] hover:bg-blue-100/70 group lg:h-[260px]">
            <div className="mb-4">
        ...
        <Link href="/service/app-development" className="block">
          <div className="rounded-lg cursor-pointer bg-amber-50 border border-amber-100 transition-all duration-300 hover:shadow-lg hover:translate-y-[-4px] hover:bg-amber-100/70 group lg:h-[260px]">
            <div className="mb-4">
              <div className="relative w-full h-28 sm:h-36 rounded-lg flex items-center justify-center transition-all duration-300">
                <Image
        ...
        <Link href="/service/branding" className="block">
          <div className="rounded-lg cursor-pointer bg-emerald-50 border border-emerald-100 transition-all duration-300 hover:shadow-lg hover:translate-y-[-4px] hover:bg-emerald-100/70 group lg:h-[260px]">
            <div className="mb-4">
              <div className="relative w-full h-28 sm:h-36 rounded-lg flex items-center justify-center transition-all duration-300">
                <Image
        ...
        <Link href="/service/digital-marketing" className="block">
          <div className="rounded-lg cursor-pointer bg-pink-50 border border-pink-100 transition-all duration-300 hover:shadow-lg hover:translate-y-[-4px] hover:bg-pink-100/70 group lg:h-[260px]">
            <div className="mb-4">
              <div className="relative w-full h-28 sm:h-36 rounded-lg flex items-center justify-center transition-all duration-300">
                <Image
        ...
        <Link href="/service/social-media" className="block">
          <div className="rounded-lg cursor-pointer bg-purple-50 border border-purple-100 transition-all duration-300 hover:shadow-lg hover:translate-y-[-4px] hover:bg-purple-100/70 group lg:h-[260px]">
            <div className="mb-4">
              <div className="relative w-full h-28 sm:h-36 rounded-lg flex items-center justify-center transition-all duration-300">
                <Image
        ...
        <Link href="/service/advertising" className="block">
          <div className="rounded-lg cursor-pointer bg-gray-50 border border-gray-200 transition-all duration-300 hover:shadow-lg hover:translate-y-[-4px] hover:bg-gray-100/70 group lg:h-[260px]">
            <div className="mb-4">
              <div className="relative w-full h-28 sm:h-36 rounded-lg flex items-center justify-center transition-all duration-300">
                <Image
