...
export default function ManeverCasestudy() {
      ...
      <div className={`h-auto lg:h-screen bg-white px-5 md:px-16 lg:px-24 py-12 lg:py-28 lg:pb-0 ${poppins.className}`}>
        <div className="mx-auto space-y-8 md:space-y-16 lg:space-y-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
            ...
            <div className="lg:col-span-8">
              <p className="text-gray-600 leading-relaxed text-base md:text-lg">
                Crafted a unisex loungewear brand that embodies comfort, versatility, and style for the whole family. Developed a brand identity and visual language that highlights togetherness and effortless living, ensuring every collection feels welcoming and adaptable to modern lifestyles.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
            ...
            <div className="lg:col-span-8">
              <p className="text-gray-600 leading-relaxed text-base md:text-lg">
                The challenge was to design a brand that seamlessly blends leisure and style, appealing to diverse age groups and lifestyles. It required balancing cozy, breathable fabrics with timeless, polished designs that transition effortlessly from home to casual outings.
              </p>
            </div>
          </div>
