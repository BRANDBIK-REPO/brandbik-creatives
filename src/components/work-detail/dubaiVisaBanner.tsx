export default function DubaiVisaBanner() {
  return (
    <div 
      className="h-[600px] relative flex items-center px-5 md:px-16 lg:px-24 bg-[url('/images/Digital-Marketing/dubai-min.jpg')] bg-cover md:bg-contain bg-right bg-no-repeat"
    >
