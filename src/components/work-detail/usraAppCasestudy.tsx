    ...
    <div className={`h-auto lg:h-screen bg-white px-5 md:px-16 lg:px-24 py-12 lg:py-28 lg:pb-0 ${poppins.className}`}>
      <div className="mx-auto space-y-8 md:space-y-16 lg:space-y-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
          ...
          <div className="lg:col-span-8">
              <p className="text-gray-600 leading-relaxed text-base md:text-lg">
                Brandbik built the Usrasa app to connect Saudi women with trusted female legal experts for private consultations, legal support, and resources. The app ensures privacy, empowerment, and cultural respect at every step.
              </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
          ...
          <div className="lg:col-span-8">
              <p className="text-gray-600 leading-relaxed text-base md:text-lg">
                Building a secure, private, and culturally sensitive app to empower women and provide easy access to legal help and resources.
              </p>
          </div>
        </div>
