      ...
      <div className={`h-auto lg:h-screen bg-white px-5 md:px-16 lg:px-24 py-12 lg:py-28 lg:pb-0 ${poppins.className}`}>
        <div className="mx-auto space-y-8 md:space-y-16 lg:space-y-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
            ...
            <div className="lg:col-span-8">
              <p className="text-gray-600 leading-relaxed text-base md:text-lg">
                Designed and developed a sleek, professional website for Cyberseed, emphasizing their role as a trusted
                corporate consultancy. Delivered a cohesive digital experience, from intuitive navigation to engaging visuals,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
            ...
            <div className="lg:col-span-8">
              <p className="text-gray-600 leading-relaxed text-base md:text-lg">
                Cyberseed required a robust, scalable web platform to showcase their consultancy expertise and engage corporate clients.  
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
            ...
            <div className="lg:col-span-8">
              <div className="space-y-4">
                {[['Responsive Web Design', 'Security Implementation', 'UI/UX Design'], ['Content Management System', 'Performance Optimization']].map((row, rowIndex) => (
