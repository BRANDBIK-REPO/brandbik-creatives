...
export default function UsrahWebGallery() {
  return (
    <div className="w-full px-4 sm:px-5 md:px-16 lg:px-24 py-6 md:py-8 lg:pb-24 h-auto">
      <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
        ...
        <div className="w-full sm:w-1/3 aspect-square rounded-2xl overflow-hidden  relative">
          <Image 
            src="/images/Web-development/usraweb-1.jpg" 
        ...
        <div className="w-full sm:w-1/3 aspect-square rounded-2xl overflow-hidden   relative">
          <Image 
            src="/images/Web-development/usraweb-2.jpg" 
        ...
        <div className="w-full sm:w-1/3 aspect-square rounded-2xl overflow-hidden   relative">
          <Image 
            src="/images/Web-development/usraweb-3.jpg" 
