...
export default function TeamaeBrandCasestudy() {
      ...
      <div className={`h-auto lg:h-screen bg-white px-5 md:px-16 lg:px-24 py-12 lg:py-28 lg:pb-0 ${poppins.className}`}>
        <div className="mx-auto space-y-8 md:space-y-16 lg:space-y-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
            ...
            <div className="lg:col-span-8">
              <p className="text-gray-600 leading-relaxed text-base md:text-lg">
                Developed a professional and approachable brand identity for Team AE, a Kerala-based business consulting firm. The branding aimed to reflect their expertise in tax, compliance, and financial advisory, while building trust and appeal for a wide range of business clients.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
            ...
            <div className="lg:col-span-8">
              <p className="text-gray-600 leading-relaxed text-base md:text-lg">
                The challenge was to position Team AE as both an expert in complex financial matters and a friendly, accessible partner. The brand needed to stand out in a competitive market, communicate reliability and transparency, and express their client-focused, data-driven approach.
              </p>
            </div>
          </div>
