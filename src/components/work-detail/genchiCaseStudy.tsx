...
export default function GenchiCaseStudyCaseStudy() {
    const services = [
      [
        ...
        "Backend Development",
        "SEO Optimization",
        "Industry-Specific Content Structuring",
        ...
        <div className="mx-auto space-y-8 md:space-y-16 lg:space-y-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
            ...
            <div className="lg:col-span-8">
              ...
              <p className="text-gray-600 leading-relaxed text-base md:text-lg block md:hidden">
                We developed a modern, responsive website for Genchi Global, a diversified contracting and investment firm with a global footprint.
              </p>
              {/* Desktop/Tablet: full text */}
              <p className="text-gray-600 leading-relaxed text-base md:text-lg hidden md:block">
                We developed a modern, responsive website for Genchi Global, a diversified contracting and investment firm with a global footprint. The site was designed to showcase Genchi Global&apos;s comprehensive services in engineering, infrastructure, water management, trading, and testing.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
            ...
            <div className="lg:col-span-8">
              {/* Mobile only: first sentence */}
              <p className="text-gray-600 leading-relaxed text-base md:text-lg block md:hidden">
                The main challenge was to create a digital presence that effectively communicates Genchi Global&apos;s diversified expertise and global reach.
              </p>
              {/* Desktop/Tablet: full text */}
              <p className="text-gray-600 leading-relaxed text-base md:text-lg hidden md:block">
                The main challenge was to create a digital presence that effectively communicates Genchi Global&apos;s diversified expertise and global reach, while presenting complex industrial services in a clear, engaging, and authoritative manner.
              </p>
            </div>
          </div>
