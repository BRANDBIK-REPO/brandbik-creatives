export default function MikaraBanner() {
    return (
      <div 
        className="h-[600px] relative flex items-center px-5 md:px-16 lg:px-24 bg-[url('/images/Web-development/mikara-1.png')] bg-cover  bg-no-repeat"
      >
        ...
        <div className="max-w-xl w-full space-y-6 relative z-10 text-white">
          ...
          <h1 className="text-white text-3xl md:text-4xl lg:text-4xl font-light leading-tight block md:hidden">
            Mikara Organics: Pure, affordable organic food across India
          </h1>
          <h1 className="text-white text-3xl md:text-4xl lg:text-4xl font-light leading-tight hidden md:block">
            Mikara Organics delivers pure, affordable organic produce nationwide—supporting farmers and customer satisfaction.
          </h1>
          ...
          <div className="space-y-4 text-white text-lg">
            <div className="flex flex-row sm:items-center gap-2 sm:gap-4">
              ...
              <span className="text-base sm:text-lg text-gray-200">Organic Food Production & Distribution</span>
            </div>
