      ...
      <div className={`h-auto lg:h-screen bg-white px-5 md:px-16 lg:px-24 py-12 lg:py-28 lg:pb-0 ${poppins.className}`}>
        <div className="mx-auto space-y-8 md:space-y-16 lg:space-y-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
            ...
            <div className="lg:col-span-8">
              <p className="text-gray-600 leading-relaxed text-base md:text-lg">
                Crafted innovative and engaging social media creative works for Vente’s Premium Blended Tender Coconut Sugar, focusing on highlighting the product’s purity and unbiased quality. The campaign aimed to elevate brand awareness and connect with health-conscious consumers through visually appealing and informative content.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
            ...
            <div className="lg:col-span-8">
              <p className="text-gray-600 leading-relaxed text-base md:text-lg">
                The main challenge was to communicate the unique benefits of Vente’s Blended Tender Coconut Sugar in a crowded market, emphasizing its pure and unbiased nature. We needed to create content that not only educated the audience but also inspired trust and encouraged engagement across social platforms.
              </p>
            </div>
          </div>
