...
export default function BiriyaniCasestudy() {
    const services = [
      ["Brand Strategy", "Visual Identity & Logo Design", "Packaging Design"],
      ...
      <div className={`h-auto lg:h-screen bg-white px-5 md:px-16 lg:px-24 py-12 lg:py-28 lg:pb-0 ${poppins.className}`}>
        <div className="mx-auto space-y-8 md:space-y-16 lg:space-y-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
            ...
            <div className="lg:col-span-8">
              <p className="text-gray-600 leading-relaxed text-base md:text-lg">
                Crafted a vibrant and authentic brand identity for Biriyani & Beyond Co, celebrating Kerala’s culinary heritage while embracing modern tastes. Delivered cohesive branding, from logo to packaging, that captures the warmth, tradition, and bold flavors at the heart of every dish.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
            ...
            <div className="lg:col-span-8">
              <p className="text-gray-600 leading-relaxed text-base md:text-lg">
                The client sought to position their biriyani brand as both rooted in tradition and innovative, appealing to food lovers seeking genuine Kerala flavors with a contemporary twist. The challenge was to evoke emotion and authenticity while standing out in a competitive market.
              </p>
            </div>
          </div>
