        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
          ...
          <div className="lg:col-span-8">
            ...
            <p className="text-gray-600 leading-relaxed text-base md:text-lg block md:hidden">
              She Talks is a mobile app designed to empower women by providing a safe space to connect, share stories, and access expert advice on life, career, and wellness.
            </p>
            {/* Desktop/Tablet text */}
