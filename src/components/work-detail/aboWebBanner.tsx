export default function AboWebBanner() {
    return (
      <div 
        className="h-[600px] relative flex items-center px-5 md:px-16 lg:px-24 bg-[url('/images/Web-development/abo-4.jpg')] bg-cover md:bg-cover  bg-no-repeat"
      >
        ...
        <div className="max-w-xl w-full space-y-6 relative z-10 text-white">
          ...
          <div className="space-y-4 text-white text-lg">
            <div className="flex flex-row sm:items-center gap-2 sm:gap-4">
              ...
              <span className="text-base sm:text-lg text-gray-200">Home Services Marketplace</span>
            </div>
