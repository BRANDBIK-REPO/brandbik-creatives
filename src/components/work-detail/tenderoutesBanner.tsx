export default function TenderoutesBanner() {
  return (
    <div 
      className=" h-[600px] relative flex items-center px-5 md:px-16 lg:px-24"
      style={{
        backgroundImage: 'url(/images/Web-development/tenderoutes-5.jpg)',
    ...
    >
      ...
      <div className="max-w-xl w-full space-y-6 relative z-10 text-white">
        ...
        Website for Tenderoutes, a Kerala-based travel operator offering custom tour packages.
        ...
        <div className="space-y-4 text-white text-lg">
          <div className="flex flex-row sm:items-center gap-2 sm:gap-4">
            ...
            <span className="text-base sm:text-lg text-gray-200">Travel & Tourism</span>
          </div>
