...
export default function AboGlumboCasestudy() {
  const services = [
    ["App Development", "UI/UX Design", "Firebase Integration"],
    ["Home Service Integration", "Booking System"],
  ];
      ...
      <div className="mx-auto space-y-8 md:space-y-16 lg:space-y-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
          ...
          <div className="lg:col-span-8">
            {/* Mobile: show only first sentence, Desktop: show full */}
            <p className="text-gray-600 leading-relaxed text-base md:text-lg block md:hidden">
              Abo Glumbo is a mobile app designed to connect users with trusted professionals for home repairs, installations, and maintenance.
            </p>
