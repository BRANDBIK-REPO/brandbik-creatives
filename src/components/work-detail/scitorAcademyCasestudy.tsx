...
export default function ScitorAcademyCaseStudy() {
    const services = [
      ["Responsive Web Design", "Performance Optimization", "SEO "],
      ["Content Management ", "UI/UX Design"],
    ]
      ...
      <div className={`h-auto lg:h-screen bg-white px-5 md:px-16 lg:px-24 py-12 lg:py-28 lg:pb-0 ${poppins.className}`}>
        <div className="mx-auto space-y-8 md:space-y-16 lg:space-y-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
            ...
            <div className="lg:col-span-8">
              <p className="text-gray-600 leading-relaxed text-base md:text-lg">
                Designed and developed a robust, scalable website for Scitor Academy to enhance their digital presence and streamline course discovery. The platform features intuitive navigation, modern visuals, and a content management system for easy updates, all tailored to support the academy&apos;s mission of delivering quality education online.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
            ...
            <div className="lg:col-span-8">
              <p className="text-gray-600 leading-relaxed text-base md:text-lg">
                The challenge was to create a high-performance, user-friendly web platform that effectively showcases Scitor Academy&rsquo;s educational offerings. The solution needed to support seamless content updates, provide fast load times, and ensure accessibility across devices while maintaining a professional and engaging brand image.
              </p>
            </div>
          </div>
