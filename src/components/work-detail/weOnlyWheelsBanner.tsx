export default function WeOnlyWheelsBanner() {
  return (
    <div 
      className="h-[600px] relative flex items-center px-5 md:px-16 lg:px-24 bg-[url('/images/Digital-Marketing/we-only-wheels.jpg')] bg-cover md:bg-contain bg-right bg-no-repeat"
    >
      ...
      <div className="max-w-xl w-full space-y-6 relative z-10 text-white">
        <h1 className="text-white text-3xl md:text-4xl lg:text-4xl font-light leading-tight">
          Innovative Social Media Creative Works for Vente’s
        </h1>
        <div className="space-y-4 text-white text-lg">
          <div className="flex flex-row sm:items-center gap-2 sm:gap-4">
            ...
            <span className="text-base sm:text-lg text-gray-200">Vente’s Premium Blended Tender Coconut Sugar</span>
          </div>
          <div className="flex flex-row sm:items-center gap-2 sm:gap-4">
