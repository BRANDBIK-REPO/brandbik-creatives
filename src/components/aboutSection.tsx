...
export default function AboutSection() {
  ...
  const stats = [
    ...
    { value: 14, label: t('about.stats.countries') },
...
<div className="absolute right-0 top-0 bottom-0 w-32 z-10">
  <div className="absolute inset-0 bg-gradient-to-l from-white/20 to-transparent"></div>
      ...
      <div className="relative z-30 container mx-auto px-1 sm:px-6 lg:px-8 pt-20 pb-16 flex flex-col min-h-screen">
        {/* About button */}
        <div className="mb-12">
          <button className="bg-teal-700 text-white px-4 py-2 rounded-full text-sm">{t('about.button')}</button>
        </div>
        ...
        <div ref={statsRef} className="mt-auto flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 pb-8 sm:pb-0">
          {isMobile ? (
            ...
            >
              ...
              >
                <StatCounter end={stats[currentStat].value} suffix="+" className="text-[22px] sm:text-[32px] font-normal text-white" />
            ...
            <>
              ...
              >
                <StatCounter end={360} suffix="+" className="text-[22px] sm:text-[32px] font-normal text-white" />
                <span className="text-gray-300 text-sm font-extralight text-[20px]">{t('about.stats.projects')}</span>
              </motion.div>
              ...
              >
                <StatCounter end={22} suffix="+" className="text-[22px] sm:text-[32px] font-normal text-white" />
                <span className="text-gray-300 text-sm font-extralight text-[20px]">{t('about.stats.countries')}</span>
              </motion.div>
              ...
              >
                <StatCounter end={37} suffix="+" className="text-[22px] sm:text-[32px] font-normal text-white" />
                <span className="text-gray-300 text-sm font-extralight text-[20px]">{t('about.stats.clients')}</span>
              </motion.div>
            </>
          )}
        </div>
