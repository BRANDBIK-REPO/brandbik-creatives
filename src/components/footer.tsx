        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 xl:gap-20">
            ...
            <div className="lg:w-1/3 s">
              ...
              <div className="text-white uppercase text-[21px] my-2">   {t('footer.brandbik')}</div>
            ...
            <div className="lg:w-2/3">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-10 lg:gap-12">
                ...
                <div className="col-span-1">
                  ...
                  <div className="flex flex-col space-y-3">
                    ...
                    <Link href="/contact" className="text-white/70 hover:text-white transition-colors duration-300 text-sm sm:text-base">{t('footer.contactUs')}</Link>
                      <Link href="/rafih-book" className="text-white/70 hover:text-white transition-colors duration-300 text-sm sm:text-base">  Rafih Book</Link>
                  </div>
                </div>
                ...
                <div className="col-span-1">
                  ...
                  <div className="flex flex-col space-y-3">
                    <Link href="/service/web-development" className="text-white/70 hover:text-white transition-colors duration-300 text-sm sm:text-base">{t('services.web.title')}</Link>
                    <Link href="/service/app-development" className="text-white/70 hover:text-white transition-colors duration-300 text-sm sm:text-base">{t('services.app.title')}</Link>
                    <Link href="/service/branding" className="text-white/70 hover:text-white transition-colors duration-300 text-sm sm:text-base">{t('services.branding.title')}</Link>
                    <Link href="/service/digital-marketing" className="text-white/70 hover:text-white transition-colors duration-300 text-sm sm:text-base">{t('services.digital.title')}</Link>
                    <Link href="/service/social-media" className="text-white/70 hover:text-white transition-colors duration-300 text-sm sm:text-base">{t('services.social.title')}</Link>
                    <Link href="/service/advertising" className="text-white/70 hover:text-white transition-colors duration-300 text-sm sm:text-base">{t('services.advertising.title')}</Link>
                  </div>
                </div>
