          ...
          <div className={`relative flex items-center justify-between w-full transition-all duration-500 ease-in-out ${
            ...
            <div className="flex-shrink-0">
              <Link href="/" prefetch>
                {isLargeScreen ? (
                  <Image
                    src={isScrolled || isDarkTextRoute ? "/images/brandbik-dark.png" : "/images/logo-brandbik.png"}
                    alt="Logo"
                    width={120}
                    height={40}
            ...
            <div className="flex items-center">
              ...
              <div className="hidden lg:flex items-center gap-1 sm:gap-2 md:gap-3">
                ...
                <button
                  ...
                  } px-2 sm:px-3 w-[156px] md:px-4 py-[8px] sm:py-[10px] rounded-full transition-all duration-300 hover:transform hover:scale-105 group`}
                >
