              ...
              >
                ...
                >
                  ...
                  <div className={`text-gray-600 sm:text-[20px] font-extralight ${poppins.className}`}>
                    {isMobile ? (showFirst ? t('work.banner.countries') : t('work.banner.industries')) : t('work.banner.countries')}
                  </div>
                </motion.div>
              </motion.div>
            </div>
            ...
            <div className="absolute sm:bottom-[11%] sm:right-[16%] z-20">
              ...
              >
                ...
                >
                  ...
                  <div className={`text-gray-600 sm:text-[20px] font-extralight ${poppins.className}`}>
                    {isMobile ? (showFirst ? t('work.banner.projects') : t('work.banner.countries')) : t('work.banner.industries')}
                  </div>
                </motion.div>
              </motion.div>
            </div>
