...
const SaverBanner = dynamic(() => import('@/components/work-detail/khbrahBanner'), {
  loading: () => <div className="h-[60vh] animate-pulse bg-gray-200" />
});

const SaverCasestudy = dynamic(() => import('@/components/work-detail/khbrahCaseStudy'), {
  loading: () => <div className="h-[400px] animate-pulse bg-gray-200" />
});

const SaverGallery = dynamic(() => import('@/components/work-detail/khbrahGallery'), {
  loading: () => <div className="h-[400px] animate-pulse bg-gray-200" />
});
...
export default function KhbrahPage() {
  return (
    <main>
