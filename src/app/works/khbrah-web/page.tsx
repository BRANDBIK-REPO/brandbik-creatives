...
const SheTalksWebBanner = dynamic(() => import('@/components/work-detail/khbrahWebBanner'), {
  loading: () => <div className="h-[60vh] animate-pulse bg-gray-200" />
});

const SheTalksWebCasestudy = dynamic(() => import('@/components/work-detail/khbrahWebCaseStudy'), {
  loading: () => <div className="h-[400px] animate-pulse bg-gray-200" />
});

const SheTalksWebGallery = dynamic(() => import('@/components/work-detail/khbrahWebGallery'), {
  loading: () => <div className="h-[400px] animate-pulse bg-gray-200" />
});
