...
const GenchiBanner = dynamic(() => import('@/components/work-detail/genchiBanner'), {
  loading: () => <div className="h-[60vh] animate-pulse bg-gray-200" />
});

const GenchiCasestudy = dynamic(() => import('@/components/work-detail/genchiCaseStudy'), {
  loading: () => <div className="h-[400px] animate-pulse bg-gray-200" />
});

const GenchiGallery = dynamic(() => import('@/components/work-detail/genchiGallery'), {
  loading: () => <div className="h-[400px] animate-pulse bg-gray-200" />
});
