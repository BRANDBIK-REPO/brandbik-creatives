...
const SheTalksWebBanner = dynamic(() => import('@/components/work-detail/shetalksWebBanner'), {
  loading: () => <div className="h-[60vh] animate-pulse bg-gray-200" />
});

const SheTalksWebCasestudy = dynamic(() => import('@/components/work-detail/shetalksWebCaseStudy'), {
  loading: () => <div className="h-[400px] animate-pulse bg-gray-200" />
});

const SheTalksWebGallery = dynamic(() => import('@/components/work-detail/shetalksWebGallery'), {
  loading: () => <div className="h-[400px] animate-pulse bg-gray-200" />
});
...
export default function SheTalksWeb() {
  return (
    <>
