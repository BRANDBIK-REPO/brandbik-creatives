...
const GreenDoorBanner = dynamic(() => import('@/components/work-detail/tenderoutesSocialBanner'), {
  loading: () => <div className="h-[60vh] animate-pulse bg-gray-200" />
});

const GreenDoorCaseStudy = dynamic(() => import('@/components/work-detail/tenderoutesSocialCaseStudy'), {
  loading: () => <div className="h-[400px] animate-pulse bg-gray-200" />
});

const GreenDoorGallery = dynamic(() => import('@/components/work-detail/tenderoutesSocialGallery'), {
  loading: () => <div className="h-[400px] animate-pulse bg-gray-200" />
});
...
export default function TenderoutesSocial() {
  return (
    <>
