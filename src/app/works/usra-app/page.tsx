...
const SheTalksWebBanner = dynamic(() => import('@/components/work-detail/usraAppBanner'), {
  loading: () => <div className="h-[60vh] animate-pulse bg-gray-200" />
});

const SheTalksWebCasestudy = dynamic(() => import('@/components/work-detail/usraAppCasestudy'), {
  loading: () => <div className="h-[400px] animate-pulse bg-gray-200" />
});

const SheTalksWebGallery = dynamic(() => import('@/components/work-detail/usraAppGallery'), {
  loading: () => <div className="h-[400px] animate-pulse bg-gray-200" />
});
